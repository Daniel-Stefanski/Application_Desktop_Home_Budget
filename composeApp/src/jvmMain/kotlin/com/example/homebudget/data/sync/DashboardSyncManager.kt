...
object DashboardSyncManager {
    suspend fun sync(): Boolean = withContext(Dispatchers.IO) {
        val localUserId = Prefs.getLastLoggedUser() ?: return@withContext false
        val supabaseUid = Prefs.getSupabaseUid()
        if (supabaseUid.isNullOrBlank()) return@withContext false
        ...
        try {
            ...
            if (remoteSettings != null) {
                ...
                if (existingSettings == null) {
                    ...
                    settingsDao.update(localSettings.copy(id = existingSettings.id))
                }
            }
            ...
            val localContributions = remoteContributions.mapNotNull { remote ->
                goalIdMap[remote.goal_id]?.let { remote.toLocal(localUserId, it) }
            }
